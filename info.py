...
CLOSE_IMG = environ.get('CLOSE_IMG', "https://te.legra.ph/file/b54f74036058067bb9e68.jpg")
BOT_START_TIME = time()
...
START_MESSAGE = environ.get('START_MESSAGE', '<b>ʜᴇʏ,{user}\n\n𝘐 ɪ ᴀᴍ ᴀ ᴀᴜᴛᴏғɪʟᴛᴇʀ + ᴍᴀɴᴜᴀʟғɪʟᴛᴇʀ  + ғɪʟᴇsᴛᴏʀᴇ ʙᴏᴛ I ᴡɪʟʟ ɢɪᴠᴇ ᴍᴏᴠɪᴇs ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍʏ ᴘᴍ ! ᴀʟsᴏ ɪ ᴄᴀɴ sᴛᴏʀᴇ ғɪʟᴇs\n\n ©ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ :</b>')
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>🧿 Title : </b> : <b><i><a href={url}>{title}</a></i></b><b>\n🎭 Genre : </b> :<b><i>{genres}</i></b><b>\n⭐️ Ratings </b> : <b><i><a href={url}/ratings>{rating}</a> / 10 (ʙᴀsᴇᴅ ᴏɴ {votes} ᴜsᴇʀ ʀᴀᴛɪɴɢ.)</i></b><b>\n\n📆 Release </b> : <b><i>{release_date}</i></b><b>\n🎙 Language</b> : <b><i>{languages}</i></b><b>\n⏰ Duration</b> : <b><i>{countries}</i></b><b>\n</b>🔖 Short info<b> : <code>{plot}</code>")
