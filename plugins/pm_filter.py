...
async def pm_next_page(bot, query):
    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("⬅️𝒃𝒂𝒄𝒌", callback_data=f"pmnext_{req}_{key}_{off_set}"),
             InlineKeyboardButton(f"🔰𝒑𝒂𝒈𝒆 {math.ceil(int(offset) / 10) + 1} / {math.ceil(total / 10)}", callback_data="pages")]                                  
        )
    elif off_set is None:
        btn.append(
            [InlineKeyboardButton(f"🔰𝒑𝒂𝒈𝒆 {math.ceil(int(offset) / 10) + 1} / {math.ceil(total / 10)}", callback_data="pages"),
             InlineKeyboardButton("𝖓𝖊𝖝𝖙➡️", callback_data=f"pmnext_{req}_{key}_{n_offset}")])
    else:
        btn.append(
            [
                InlineKeyboardButton("⬅️𝒃𝒂𝒄𝒌", callback_data=f"pmnext_{req}_{key}_{off_set}"),
...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("⬅️𝒃𝒂𝒄𝒌", callback_data=f"next_{req}_{key}_{off_set}"),
             InlineKeyboardButton(f"📚𝒑𝒂𝒈𝒆 {math.ceil(int(offset) / 10) + 1} / {math.ceil(total / 10)}",
                                  callback_data="pages")]
        )
    elif off_set is None:
        btn.append(
            [InlineKeyboardButton(f"📚𝒑𝒂𝒈𝒆 {math.ceil(int(offset) / 10) + 1} / {math.ceil(total / 10)}", callback_data="pages"),
             InlineKeyboardButton("𝖓𝖊𝖝𝖙➡️", callback_data=f"next_{req}_{key}_{n_offset}")])
    else:
        btn.append(
            [
                InlineKeyboardButton("⬅️𝒃𝒂𝒄𝒌", callback_data=f"next_{req}_{key}_{off_set}"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[                               
            InlineKeyboardButton('𝑴-𝑭𝒊𝒍𝒕𝒆𝒓', callback_data='manuelfilter'),
            InlineKeyboardButton('𝐀-𝐅𝐢𝐥𝐭𝐞𝐫', callback_data='autofilter')
            ],[
            InlineKeyboardButton('𝑪𝒐𝒏𝒏𝒆𝒄𝒕𝒊𝒐𝒏𝒔', callback_data='coct'),
            InlineKeyboardButton('𝑬𝒙𝒕𝒓𝒂-𝑴𝒐𝒅𝒔', callback_data='extra')   
            ],[
            InlineKeyboardButton('𝑺𝒕𝒂𝒕𝒖𝒔', callback_data='stats'),
            InlineKeyboardButton('𝖓𝖊𝖝𝖙»', callback_data='help2')
            ],[
            InlineKeyboardButton('🔍𝑰𝒏𝒍𝒊𝒏𝒆 𝑺𝒆𝒂𝒓𝒄𝒉 𝑴𝒐𝒗𝒊𝒆 𝑯𝒆𝒓𝒆🔍', switch_inline_query_current_chat=''),
         ]] 
        reply_markup = InlineKeyboardMarkup(buttons)             
        await query.message.edit_text(                     
        ...
        buttons = [[                               
            InlineKeyboardButton('𝑻𝒆-𝑷𝒉𝒐𝒕𝒐', callback_data='tele'),
            InlineKeyboardButton('𝑺𝒉𝒂𝒓𝒆-𝑻𝒆𝒙𝒕', callback_data='sharetxt'),
            InlineKeyboardButton('𝑭𝒊𝒍𝒆-𝑺𝒕𝒐𝒓𝒆', callback_data='newdata')
            ],[           
            InlineKeyboardButton('𝑱𝒔𝒐𝒏𝒆', callback_data='son'),
            InlineKeyboardButton('𝑻𝒕𝒔', callback_data='ttss'),           
            InlineKeyboardButton('𝑷𝒖𝒓𝒈𝒆', callback_data='purges')
            ],[
            InlineKeyboardButton('𝑷𝒂𝒔𝒕𝒆', callback_data='pastes'),
            InlineKeyboardButton("𝑰𝒎𝒂𝒈𝒆", callback_data='image'),
            InlineKeyboardButton('𝑷𝒊𝒏𝒈', callback_data='pings')                                   
            ],[
            InlineKeyboardButton('«𝒃𝒂𝒄𝒌', callback_data='help1'),
            InlineKeyboardButton('𝖓𝖊𝖝𝖙»', callback_data='help3')
            ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝑲𝒊𝒄𝒌', callback_data='zombies'),
            InlineKeyboardButton('𝑷𝒊𝒏', callback_data='pin')
            ],[
            InlineKeyboardButton('«𝒃𝒂𝒄𝒌', callback_data='help2'),
            InlineKeyboardButton('𝑫𝒆𝒑𝒍𝒐𝒚', callback_data='source'),
            InlineKeyboardButton('𝑼𝒓𝒍-𝑺𝒉𝒐𝒓𝒕', callback_data='urlshort'),
         ]]
        reply_markup = InlineKeyboardMarkup(buttons)             
        await query.message.edit_text(                     
            text=script.HELP_TXT.format(query.from_user.mention),
        ...
        buttons= [[
            ...
            InlineKeyboardButton('«𝒃𝒂𝒄𝒌 ', callback_data='start'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('«𝒃𝒂𝒄𝒌', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('«𝒃𝒂𝒄𝒌', callback_data='help3')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('«𝒃𝒂𝒄𝒌', callback_data='help'),
        ...
        buttons = [[
            InlineKeyboardButton('«𝒃𝒂𝒄𝒌', callback_data='manuelfilter')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('«𝒃𝒂𝒄𝒌', callback_data='extra')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[            
            InlineKeyboardButton('«𝒃𝒂𝒄𝒌', callback_data='admin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)        
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        req = message.from_user.id if message.from_user else 0
        btn.append(
            [InlineKeyboardButton(text=f"📚𝒑𝒂𝒈𝒆 1/{math.ceil(int(total_results) / 6)}", callback_data="pages"),
             InlineKeyboardButton(text="𝖓𝖊𝖝𝖙➡️", callback_data=f"next_{req}_{key}_{offset}")]
        )
    else:
        btn.append(
            [InlineKeyboardButton(text="📚𝒑𝒂𝒈𝒆 1/1", callback_data="pages")]
        )
    ...
    if imdb:
        ...
        cap = f"<b>📁 Here is What I Found In My Database For Your Query</b> :<b>{search}</b>"
...
async def pm_AutoFilter(client, msg, pmspoll=False):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text=f"📚𝒑𝒂𝒈𝒆 1/{math.ceil(int(total_results) / 6)}", callback_data="pages"),
            InlineKeyboardButton(text="𝖓𝖊𝖝𝖙➡️", callback_data=f"pmnext_{req}_{key}_{offset}")]
        )
    else:
        btn.append(
            [InlineKeyboardButton(text="📚𝒑𝒂𝒈𝒆 1/1", callback_data="pages")]
